              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto 28px auto;">
                <tr>
                  <td align="center" bgcolor="#FF4B2B" style="border-radius:10px;">
                    <a href="https://suphian.com" style="display:inline-block;padding:16px 32px;font-size:15px;font-weight:700;color:#0F0F11;text-decoration:none;">Visit Suphian.com</a>
                  </td>
                </tr>
              </table>
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
                <tr>
                  <td style="padding:0 8px;">
                    <a href="https://linkedin.com/in/suphian" style="font-size:14px;font-weight:600;color:#E5E7EB;text-decoration:none;">LinkedIn</a>
                  </td>
                  <td style="padding:0 8px;">
                    <a href="https://github.com/suphian" style="font-size:14px;font-weight:600;color:#E5E7EB;text-decoration:none;">GitHub</a>
                  </td>
                </tr>
              </table>
            </td>
