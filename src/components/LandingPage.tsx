    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="max-w-4xl">
        ...
        <div className="space-y-4 text-content">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl font-montserrat font-bold">
            Previously, built experiences for Hulu, Apple, Duolingo, and Chewy.com.
          </p>
          
          <p className="text-xl md:text-2xl lg:text-3xl font-montserrat font-bold">
            Passionate about crafting exception experiences with data by thoughtful design and cutting-edge tech.
          </p>
        </div>
