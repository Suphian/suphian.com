...
const ExperienceSection = () => {
  const experiences = [{
    ...
    description: "Specialized in site redesigns, A/B testing, and multivariate testing for high-impact brands. Helped improve UX and conversion for companies like Hulu, Apple and Canada Goose.",
    links: [{
