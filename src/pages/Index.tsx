...
// Import About page content components
    ...
    <div className="relative">
      ...
      <div className="relative min-h-[200vh] bg-black">
        ...
        >
          ...
          {/* About Section (content from About.tsx) */}
          <div className="pt-20 pb-24">
            <div className="container-custom">
              ...
              <section id="leadership-section" className="bg-secondary/30 p-8 md:p-12 rounded-2xl reveal mb-20">
